...
class LEVELDB_EXPORT Env {
 public:
  ...
  // virtual Status NewWritableFile2(int fd,const std::string& filename,
  //                        WritableFile** result) =0;                                  
...
class LEVELDB_EXPORT EnvWrapper : public Env {
 public:
  ...
  // Status NewWritableFile2(int fd,const std::string& filename, WritableFile** r) override {
  //   return target_->NewWritableFile2(fd,filename,r);
  // }
...
// persistent memory write interface: filename_   mmap_base   length
